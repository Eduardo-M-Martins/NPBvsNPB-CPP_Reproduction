...
c      parameter (fftblock_default=32, fftblockpad_default=33)
c     dflt==1, default behavior for the blocks
      parameter (fftblock_default=dflt, fftblockpad_default=dflt)
